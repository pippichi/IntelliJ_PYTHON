...
class SentimentClassifier:
    def __init__(self):
        if os.path.exists('corpus\\train.csv') and os.path.exists('corpus\\test.csv'):
            ...
            self.train_y = self.loan_feature("C:\\Users\\HASEE\\Desktop\\ai_challenger_sentiment_analysis_trainingset_20180816\\sentiment_analysis_trainingset.csv")
            self.test_y = self.loan_feature("C:\\Users\\HASEE\\Desktop\\ai_challenger_sentiment_analysis_validationset_20180816\\sentiment_analysis_validationset.csv")
            ...
            self.X_train, self.X_val,self.y_train, self.y_val = self.train_data,self.test_data,self.train_y,self.test_y
            self.model = None
            self.load_model()
    ...
    def loan_feature(self, filename):
        # lists = []
        ...
        lists = []
        for each in Motion_result[:,2:22]:
            lists.append(each)
        return lists
